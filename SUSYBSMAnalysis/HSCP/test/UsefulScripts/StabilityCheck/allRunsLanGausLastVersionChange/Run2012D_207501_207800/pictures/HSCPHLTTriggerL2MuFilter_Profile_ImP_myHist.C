...
//=========  (Fri Aug 22 13:25:39 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerL2MuFiltermyHist = new TProfile("HSCPHLTTriggerL2MuFiltermyHist","",3,0,3,"");
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(1,1872);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(2,55);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(3,68);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(1,6552.376);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(2,190.4329);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(3,239.9839);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(1,152.8232);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(2,25.81265);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(3,29.36547);
   HSCPHLTTriggerL2MuFiltermyHist->SetEntries(1995);
   ...
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(1,"207515");
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(2,"207517");
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(3,"207518");
   ...
   TPaveText *pt = new TPaveText(7.070164e-316,2.321585e-310,7.681063e-316,7.475357e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
