...
//=========  (Fri Aug 22 13:25:57 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerHtDeDxFilterdEdxMSProf = new TProfile("HSCPHLTTriggerHtDeDxFilterdEdxMSProf","",3,0,3,"");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinEntries(1,20);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinEntries(3,2);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinContent(1,66.1398);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinContent(3,7.057351);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinError(1,14.82532);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinError(3,4.991569);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetEntries(22);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"207515");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(2,"207517");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(3,"207518");
   ...
   TPaveText *pt = new TPaveText(7.542978e-316,7.542994e-316,2.371515e-322,2.371515e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
