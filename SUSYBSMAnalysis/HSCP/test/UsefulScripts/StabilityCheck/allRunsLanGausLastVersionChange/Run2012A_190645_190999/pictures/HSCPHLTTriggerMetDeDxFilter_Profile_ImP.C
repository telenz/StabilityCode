...
//=========  (Fri Aug 22 13:20:40 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(203);
   ...
   TPaveText *pt = new TPaveText(1.591317e-314,7.291122e-304,2.370219e-310,0,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
