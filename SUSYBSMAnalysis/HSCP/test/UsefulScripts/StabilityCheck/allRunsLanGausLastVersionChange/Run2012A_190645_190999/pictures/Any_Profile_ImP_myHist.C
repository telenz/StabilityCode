...
//=========  (Fri Aug 22 13:18:59 2014) by ROOT version5.32/00
   ...
   TPaveText *pt = new TPaveText(1.640163e-314,1.691331e-314,2.370219e-310,1.649034e-314,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
   TText *text = pt->AddText(" Ö");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
