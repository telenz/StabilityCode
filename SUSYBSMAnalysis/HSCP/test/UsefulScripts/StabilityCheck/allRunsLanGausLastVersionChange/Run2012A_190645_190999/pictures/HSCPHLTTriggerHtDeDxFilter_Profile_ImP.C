...
//=========  (Fri Aug 22 13:22:19 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetEntries(10);
   ...
   TPaveText *pt = new TPaveText(1.656569e-314,1.648625e-314,1.656569e-314,1.656569e-314,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
