...
//=========  (Fri Aug 22 13:23:03 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(1554);
   ...
   TPaveText *pt = new TPaveText(1.653746e-314,1.642672e-314,0,2.420922e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
