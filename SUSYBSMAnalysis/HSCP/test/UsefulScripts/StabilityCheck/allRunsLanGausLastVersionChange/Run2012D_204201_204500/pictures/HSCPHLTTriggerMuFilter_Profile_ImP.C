...
//=========  (Fri Aug 22 13:43:02 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,2476);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(2,51629);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,7387.346);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(2,154564.8);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,150.3614);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(2,689.2644);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(54105);
   ...
   TPaveText *pt = new TPaveText(6.778241e-316,8.394682e-316,6.32404e-322,2.371515e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
