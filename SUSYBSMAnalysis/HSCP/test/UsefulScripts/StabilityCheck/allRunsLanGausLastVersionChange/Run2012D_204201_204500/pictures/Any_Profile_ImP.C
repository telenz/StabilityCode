...
//=========  (Fri Aug 22 13:40:13 2014) by ROOT version5.32/00
   ...
   AnydEdxMPProf->SetBinEntries(1,2512);
   AnydEdxMPProf->SetBinEntries(2,52123);
   AnydEdxMPProf->SetBinContent(1,7496.536);
   AnydEdxMPProf->SetBinContent(2,156069);
   AnydEdxMPProf->SetBinError(1,151.4841);
   AnydEdxMPProf->SetBinError(2,692.6869);
   AnydEdxMPProf->SetEntries(54635);
   ...
   TPaveText *pt = new TPaveText(6.748465e-316,2.326726e-310,1.019779e-315,6.748466e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
