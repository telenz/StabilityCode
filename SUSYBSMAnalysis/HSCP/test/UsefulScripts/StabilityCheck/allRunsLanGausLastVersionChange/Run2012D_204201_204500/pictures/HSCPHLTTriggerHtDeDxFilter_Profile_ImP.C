...
//=========  (Fri Aug 22 13:45:35 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(2,18);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(1,2.883989);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(2,54.1816);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(1,2.883989);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(2,12.95084);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetEntries(19);
   ...
   TPaveText *pt = new TPaveText(6.563658e-316,2.326726e-310,2.326725e-310,6.563241e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
