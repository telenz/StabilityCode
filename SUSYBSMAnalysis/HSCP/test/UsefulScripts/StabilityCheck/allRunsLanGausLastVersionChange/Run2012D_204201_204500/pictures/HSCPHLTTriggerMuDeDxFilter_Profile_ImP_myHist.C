...
//=========  (Fri Aug 22 13:47:36 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerMuDeDxFiltermyHist = new TProfile("HSCPHLTTriggerMuDeDxFiltermyHist","",2,0,2,"");
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(1,109);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(2,2436);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(1,419.6112);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(2,9433.42);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(1,40.65657);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(2,193.625);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetEntries(2545);
   ...
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"204238");
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(5.095746e-316,7.291122e-304,2.326725e-310,2.521751e+180,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
