...
//=========  (Fri Aug 22 13:43:54 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerMetDeDxFilterdEdxMPProf = new TProfile("HSCPHLTTriggerMetDeDxFilterdEdxMPProf","",2,0,2,"");
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(1,23);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(2,388);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,78.82294);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(2,1317.896);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,16.77046);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(2,68.07293);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(411);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"204238");
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(8.068603e-316,7.291122e-304,2.326725e-310,1.987532e-14,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
