...
//=========  (Fri Aug 22 13:45:26 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerHtDeDxFilterdEdxMProf = new TProfile("HSCPHLTTriggerHtDeDxFilterdEdxMProf","",2,0,2,"");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinEntries(1,1);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinEntries(2,23);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinContent(1,3.215914);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinContent(2,73.45522);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinError(1,3.215914);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinError(2,15.3604);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"204238");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(7.47543e-316,7.291122e-304,2.326725e-310,6.776943e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
