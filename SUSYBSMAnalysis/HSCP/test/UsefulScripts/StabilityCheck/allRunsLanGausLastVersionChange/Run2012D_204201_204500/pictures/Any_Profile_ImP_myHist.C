...
//=========  (Fri Aug 22 13:40:18 2014) by ROOT version5.32/00
   ...
   TProfile *AnymyHist = new TProfile("AnymyHist","",2,0,2,"");
   AnymyHist->SetBinEntries(1,2382);
   AnymyHist->SetBinEntries(2,47154);
   AnymyHist->SetBinContent(1,8319.243);
   AnymyHist->SetBinContent(2,165113.5);
   AnymyHist->SetBinError(1,171.8569);
   AnymyHist->SetBinError(2,766.8997);
   AnymyHist->SetEntries(49536);
   ...
   AnymyHist->GetXaxis()->SetBinLabel(1,"204238");
   AnymyHist->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(8.394662e-316,2.326726e-310,6.739051e-316,6.738203e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
