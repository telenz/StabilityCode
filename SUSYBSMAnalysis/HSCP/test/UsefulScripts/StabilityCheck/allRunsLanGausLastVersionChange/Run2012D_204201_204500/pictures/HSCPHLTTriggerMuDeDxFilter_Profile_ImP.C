...
//=========  (Fri Aug 22 13:47:32 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,98);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(2,2386);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,338.5362);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(2,8258.357);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,34.65599);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(2,171.6086);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(2484);
   ...
   TPaveText *pt = new TPaveText(6.257654e-316,7.475753e-316,2.326725e-310,0,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
