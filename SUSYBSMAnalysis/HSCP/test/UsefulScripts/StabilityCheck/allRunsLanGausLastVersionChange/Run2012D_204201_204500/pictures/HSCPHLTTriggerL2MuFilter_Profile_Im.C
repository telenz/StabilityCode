...
//=========  (Fri Aug 22 13:44:38 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerL2MuFilterdEdxMProf = new TProfile("HSCPHLTTriggerL2MuFilterdEdxMProf","",2,0,2,"");
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinEntries(1,102);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinEntries(2,1513);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinContent(1,322.9628);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinContent(2,4769.325);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinError(1,32.04826);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinError(2,123.0107);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetEntries(1615);
   ...
   HSCPHLTTriggerL2MuFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"204238");
   HSCPHLTTriggerL2MuFilterdEdxMProf->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(6.579003e-316,2.326726e-310,7.475794e-316,8.068634e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
