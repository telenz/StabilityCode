...
//=========  (Fri Aug 22 13:35:54 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(1,21);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(1,67.44908);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(1,14.96123);
   ...
   TPaveText *pt = new TPaveText(7.257273e-316,2.344316e-310,7.257171e-316,6.736455e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
