...
//=========  (Fri Aug 22 13:37:19 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,3862);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,13616.97);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,222.8788);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(3862);
   ...
   TPaveText *pt = new TPaveText(7.257087e-316,6.804319e-316,7.257092e-316,7.257088e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
