...
//=========  (Fri Aug 22 13:33:05 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(1,588);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,2035.893);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,85.299);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(588);
   ...
   TPaveText *pt = new TPaveText(6.995629e-316,6.995643e-316,2.344315e-310,7.149302e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
