...
//=========  (Fri Aug 22 13:29:50 2014) by ROOT version5.32/00
   ...
   AnydEdxMProf->SetBinEntries(1,89287);
   AnydEdxMProf->SetBinContent(1,283925.1);
   AnydEdxMProf->SetBinError(1,952.8379);
   AnydEdxMProf->SetEntries(89287);
   ...
   AnydEdxMProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(5.592533e-316,2.344316e-310,8.400325e-316,8.98278e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
