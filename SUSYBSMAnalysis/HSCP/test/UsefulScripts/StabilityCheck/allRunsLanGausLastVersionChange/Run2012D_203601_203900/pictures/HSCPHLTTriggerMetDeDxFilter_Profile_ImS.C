...
//=========  (Fri Aug 22 13:32:54 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetBinEntries(1,605);
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetBinContent(1,2073.8);
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetBinError(1,84.50937);
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetEntries(605);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.122192e-316,2.344316e-310,7.283001e-316,6.946953e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
