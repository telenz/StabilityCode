...
//=========  (Fri Aug 22 13:37:02 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinEntries(1,3869);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinContent(1,13217.02);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinError(1,213.0225);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetEntries(3869);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.122032e-316,2.344316e-310,6.804372e-316,7.305607e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
