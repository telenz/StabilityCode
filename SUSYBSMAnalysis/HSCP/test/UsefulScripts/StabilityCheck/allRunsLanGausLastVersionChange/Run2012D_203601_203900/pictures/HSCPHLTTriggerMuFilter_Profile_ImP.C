...
//=========  (Fri Aug 22 13:31:42 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,75983);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,228878.4);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,841.511);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(75983);
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.256933e-316,2.344316e-310,9.068645e-316,7.212019e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
