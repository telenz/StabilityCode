...
//=========  (Fri Aug 22 13:34:28 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinEntries(1,1731);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinContent(1,5732.787);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinError(1,138.0406);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetEntries(1731);
   ...
   HSCPHLTTriggerL2MuFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.305227e-316,2.344316e-310,7.12219e-316,6.741405e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
