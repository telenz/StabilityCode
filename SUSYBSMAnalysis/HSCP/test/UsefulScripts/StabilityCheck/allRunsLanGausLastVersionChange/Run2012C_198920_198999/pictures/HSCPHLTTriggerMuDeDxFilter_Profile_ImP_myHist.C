...
//=========  (Fri Aug 22 13:58:07 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(1,964);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(2,902);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(3,6306);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(4,5635);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(1,3590.679);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(2,3345.066);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(3,23590.85);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(4,20944.21);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(1,117.1136);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(2,112.7031);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(3,300.4708);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(4,281.9252);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetEntries(13807);
   ...
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"198941");
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(2,"198954");
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(3,"198955");
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(4,"198969");
   ...
   TPaveText *pt = new TPaveText(7.615913e-316,7.291122e-304,2.361728e-310,6.436962e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
