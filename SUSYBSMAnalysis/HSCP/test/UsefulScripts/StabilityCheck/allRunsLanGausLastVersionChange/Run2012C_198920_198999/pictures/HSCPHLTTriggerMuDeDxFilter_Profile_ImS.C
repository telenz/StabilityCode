...
//=========  (Fri Aug 22 13:58:01 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(1,1000);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(2,928);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(3,6695);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(4,5944);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(1,3414.418);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(2,3171.453);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(3,23039.93);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(4,20445.38);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(1,108.2246);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(2,104.3518);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(3,282.2075);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(4,265.765);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetEntries(14567);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"198941");
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(2,"198954");
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(3,"198955");
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(4,"198969");
   ...
   TPaveText *pt = new TPaveText(7.500947e-316,2.361729e-310,7.615856e-316,7.498435e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
