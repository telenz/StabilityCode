...
//=========  (Fri Aug 22 13:55:42 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(1,321);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(2,302);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(3,1514);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinEntries(4,1454);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(1,1127.429);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(2,1055.543);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(3,5297.569);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinContent(4,5055.223);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(1,63.3906);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(2,61.42811);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(3,137.2586);
   HSCPHLTTriggerL2MuFiltermyHist->SetBinError(4,133.4618);
   HSCPHLTTriggerL2MuFiltermyHist->SetEntries(3591);
   ...
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(1,"198941");
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(2,"198954");
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(3,"198955");
   HSCPHLTTriggerL2MuFiltermyHist->GetXaxis()->SetBinLabel(4,"198969");
   ...
   TPaveText *pt = new TPaveText(7.655912e-316,2.361729e-310,7.615956e-316,6.696406e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
