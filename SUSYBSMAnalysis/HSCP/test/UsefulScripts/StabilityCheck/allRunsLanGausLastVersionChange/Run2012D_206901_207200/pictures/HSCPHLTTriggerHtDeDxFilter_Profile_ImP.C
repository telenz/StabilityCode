...
//=========  (Fri Aug 22 13:54:22 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(3,21);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(4,9);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(5,2);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(2,8.515399);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(3,64.09442);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(4,25.59451);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(5,5.446463);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(2,4.941991);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(3,14.32552);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(4,8.64684);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(5,3.854092);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"206901");
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(2,"206906");
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(3,"206940");
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(4,"207099");
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(5,"207100");
   ...
   TPaveText *pt = new TPaveText(7.181594e-316,2.361872e-310,5.995719e-316,7.181677e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
