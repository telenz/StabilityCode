...
//=========  (Fri Aug 22 13:20:41 2014) by ROOT version5.32/00
   ...
   AnydEdxMPProf->SetBinEntries(1,11692);
   AnydEdxMPProf->SetBinContent(1,37132.7);
   AnydEdxMPProf->SetBinError(1,347.9767);
   AnydEdxMPProf->SetEntries(11692);
   ...
   TPaveText *pt = new TPaveText(8.765116e-316,2.359676e-310,6.673437e-316,8.409499e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
