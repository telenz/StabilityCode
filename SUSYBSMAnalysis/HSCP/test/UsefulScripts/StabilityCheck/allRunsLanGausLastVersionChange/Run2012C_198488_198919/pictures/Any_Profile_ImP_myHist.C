...
//=========  (Fri Aug 22 13:20:54 2014) by ROOT version5.32/00
   ...
   TPaveText *pt = new TPaveText(8.417838e-316,8.76511e-316,8.417844e-316,8.417839e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
   TText *text = pt->AddText("pév");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
