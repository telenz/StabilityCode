...
//=========  (Fri Aug 22 13:24:07 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(1,149);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,531.7779);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,44.12322);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(149);
   ...
   TPaveText *pt = new TPaveText(8.648441e-316,2.359676e-310,5.469185e-316,8.396003e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
