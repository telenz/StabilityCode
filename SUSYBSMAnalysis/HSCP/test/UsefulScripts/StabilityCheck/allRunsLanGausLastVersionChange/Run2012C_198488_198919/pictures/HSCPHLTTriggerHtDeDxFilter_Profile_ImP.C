...
//=========  (Fri Aug 22 13:28:18 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(1,21.93756);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(1,8.542729);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetEntries(7);
   ...
   TPaveText *pt = new TPaveText(8.417688e-316,9.73691e-316,8.417726e-316,8.417689e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
