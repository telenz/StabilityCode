...
//=========  (Fri Aug 22 13:20:15 2014) by ROOT version5.32/00
   ...
   AnydEdxMProf->SetBinEntries(1,12628);
   AnydEdxMProf->SetBinContent(1,40554.77);
   AnydEdxMProf->SetBinError(1,361.9067);
   AnydEdxMProf->SetEntries(12628);
   ...
   AnydEdxMProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(8.599103e-316,8.716265e-316,8.599104e-316,8.508649e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
