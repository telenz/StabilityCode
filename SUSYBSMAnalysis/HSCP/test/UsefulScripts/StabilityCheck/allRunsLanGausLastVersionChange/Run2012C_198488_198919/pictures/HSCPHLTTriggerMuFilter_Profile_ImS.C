...
//=========  (Fri Aug 22 13:22:09 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinEntries(1,12571);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinContent(1,41479.49);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinError(1,370.6308);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetEntries(12571);
   ...
   HSCPHLTTriggerMuFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(8.569129e-316,7.778823e-316,2.359675e-310,8.415324e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
