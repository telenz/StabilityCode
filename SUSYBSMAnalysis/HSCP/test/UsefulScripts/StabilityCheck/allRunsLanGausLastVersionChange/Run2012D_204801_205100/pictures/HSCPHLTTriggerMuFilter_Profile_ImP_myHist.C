...
//=========  (Fri Aug 22 13:20:21 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFiltermyHist->SetBinEntries(1,270);
   HSCPHLTTriggerMuFiltermyHist->SetBinContent(1,955.1774);
   HSCPHLTTriggerMuFiltermyHist->SetBinError(1,58.70803);
   HSCPHLTTriggerMuFiltermyHist->SetEntries(270);
   ...
   HSCPHLTTriggerMuFiltermyHist->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.754508e-316,2.363913e-310,6.885607e-316,6.847402e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
