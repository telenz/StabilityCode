...
//=========  (Fri Aug 22 13:18:52 2014) by ROOT version5.32/00
   ...
   TPaveText *pt = new TPaveText(6.725727e-316,2.363913e-310,6.834219e-316,6.650791e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
   TText *text = pt->AddText("pٸ");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
