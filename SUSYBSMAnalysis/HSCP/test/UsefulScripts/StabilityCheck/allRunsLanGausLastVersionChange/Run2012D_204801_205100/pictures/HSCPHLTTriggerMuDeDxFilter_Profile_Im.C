...
//=========  (Fri Aug 22 13:24:51 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinEntries(1,13);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinContent(1,44.73744);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetBinError(1,12.42078);
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->SetEntries(13);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.765781e-316,6.848339e-316,6.989867e-316,7.001348e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
