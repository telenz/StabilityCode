...
//=========  (Fri Aug 22 13:18:43 2014) by ROOT version5.32/00
   ...
   AnydEdxMPProf->SetBinEntries(1,314);
   AnydEdxMPProf->SetBinContent(1,961.0721);
   AnydEdxMPProf->SetBinError(1,55.01081);
   AnydEdxMPProf->SetEntries(314);
   ...
   TPaveText *pt = new TPaveText(6.664892e-316,7.291122e-304,2.363911e-310,6.767229e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
