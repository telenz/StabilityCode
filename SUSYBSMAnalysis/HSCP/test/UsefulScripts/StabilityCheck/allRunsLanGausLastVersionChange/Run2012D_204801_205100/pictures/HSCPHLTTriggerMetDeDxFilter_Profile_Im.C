...
//=========  (Fri Aug 22 13:21:17 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(1,6.798811);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(1,4.81481);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetEntries(2);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.896707e-316,6.725723e-316,2.363911e-310,6.653902e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
