...
//=========  (Fri Aug 22 13:25:08 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,13);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,46.24767);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,13.00431);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(13);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.765771e-316,2.363913e-310,6.989869e-316,6.819575e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
