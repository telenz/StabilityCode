...
//=========  (Fri Aug 22 13:19:46 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinEntries(1,349);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinContent(1,1111.307);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinError(1,59.64688);
   HSCPHLTTriggerMuFilterdEdxMProf->SetEntries(349);
   ...
   HSCPHLTTriggerMuFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.005983e-316,7.000626e-316,2.363911e-310,6.683043e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
