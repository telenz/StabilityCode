...
//=========  (Fri Aug 22 13:20:13 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,302);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,921.3406);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,53.75543);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(302);
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.685903e-316,6.896717e-316,2.363911e-310,6.822273e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
