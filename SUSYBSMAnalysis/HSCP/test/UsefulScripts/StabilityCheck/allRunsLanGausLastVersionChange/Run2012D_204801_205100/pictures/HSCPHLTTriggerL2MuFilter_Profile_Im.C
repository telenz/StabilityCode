...
//=========  (Fri Aug 22 13:22:33 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinEntries(1,7);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinContent(1,23.08853);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetBinError(1,8.740166);
   HSCPHLTTriggerL2MuFilterdEdxMProf->SetEntries(7);
   ...
   HSCPHLTTriggerL2MuFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.756346e-316,2.363913e-310,6.685919e-316,6.652335e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
