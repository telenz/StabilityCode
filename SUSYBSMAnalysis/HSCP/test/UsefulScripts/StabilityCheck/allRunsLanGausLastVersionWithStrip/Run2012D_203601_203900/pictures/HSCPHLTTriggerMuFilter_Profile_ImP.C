...
//=========  (Thu Aug 21 17:46:00 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,37470);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,127873);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,665.8377);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(37470);
   ...
   TPaveText *pt = new TPaveText(2.346632e-310,2.346632e-310,5.422982e-316,5.161384e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
