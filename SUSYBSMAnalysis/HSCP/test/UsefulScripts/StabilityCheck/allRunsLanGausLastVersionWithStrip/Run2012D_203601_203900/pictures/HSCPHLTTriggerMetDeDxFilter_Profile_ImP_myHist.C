...
//=========  (Thu Aug 21 17:47:37 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFiltermyHist->SetBinEntries(1,591);
   HSCPHLTTriggerMetDeDxFiltermyHist->SetBinContent(1,2280.971);
   HSCPHLTTriggerMetDeDxFiltermyHist->SetBinError(1,95.08602);
   HSCPHLTTriggerMetDeDxFiltermyHist->SetEntries(591);
   ...
   HSCPHLTTriggerMetDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.293063e-316,5.506663e-316,6.32404e-322,2.371515e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
