...
//=========  (Thu Aug 21 17:44:28 2014) by ROOT version5.32/00
   ...
   AnydEdxMPProf->SetBinEntries(1,37793);
   AnydEdxMPProf->SetBinContent(1,128992.6);
   AnydEdxMPProf->SetBinError(1,668.8125);
   AnydEdxMPProf->SetEntries(37793);
   ...
   TPaveText *pt = new TPaveText(2.346632e-310,2.346632e-310,2.346631e-310,0,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
