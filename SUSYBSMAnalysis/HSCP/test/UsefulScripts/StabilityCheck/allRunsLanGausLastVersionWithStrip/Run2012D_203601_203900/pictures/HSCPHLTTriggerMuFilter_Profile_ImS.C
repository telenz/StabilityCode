...
//=========  (Thu Aug 21 17:45:51 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinEntries(1,88628);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinContent(1,293959.2);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinError(1,989.2525);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetEntries(88628);
   ...
   HSCPHLTTriggerMuFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(4.115056e-316,7.293046e-316,2.346631e-310,7.269105e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
