...
//=========  (Thu Aug 21 17:51:19 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinEntries(1,3917);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinContent(1,15371.16);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetBinError(1,249.3308);
   HSCPHLTTriggerMuDeDxFiltermyHist->SetEntries(3917);
   ...
   HSCPHLTTriggerMuDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(5.709612e-316,2.346632e-310,7.221414e-316,5.508397e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
