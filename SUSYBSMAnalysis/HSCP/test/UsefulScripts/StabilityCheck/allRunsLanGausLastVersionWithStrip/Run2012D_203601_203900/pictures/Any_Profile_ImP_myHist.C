...
//=========  (Thu Aug 21 17:44:37 2014) by ROOT version5.32/00
   ...
   AnymyHist->SetBinEntries(1,66398);
   AnymyHist->SetBinContent(1,233484.7);
   AnymyHist->SetBinError(1,914.2287);
   AnymyHist->SetEntries(66398);
   ...
   AnymyHist->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(7.271566e-316,5.552355e-316,7.271567e-316,6.627211e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
