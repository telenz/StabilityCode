...
//=========  (Thu Aug 21 17:45:42 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerMuFilterdEdxMProf = new TProfile("HSCPHLTTriggerMuFilterdEdxMProf","",1,0,1,"");
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinEntries(1,88628);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinContent(1,281815.8);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinError(1,949.262);
   HSCPHLTTriggerMuFilterdEdxMProf->SetEntries(88628);
   ...
   HSCPHLTTriggerMuFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"203894");
   ...
   TPaveText *pt = new TPaveText(5.506578e-316,2.346632e-310,5.507012e-316,5.231928e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
