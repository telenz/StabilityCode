...
//=========  (Thu Aug 21 17:28:04 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,31);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(3,638);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(4,600);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,115.5627);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(3,2325.054);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(4,2177.39);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,21.06479);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(3,92.98348);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(4,89.7723);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(1269);
   ...
   TPaveText *pt = new TPaveText(9.189027e-316,9.522962e-316,8.440829e-316,6.813238e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
