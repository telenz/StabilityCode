...
//=========  (Thu Aug 21 17:27:43 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(3,4);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinEntries(4,4);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(3,13.69357);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(4,15.24123);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(3,6.866983);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(4,7.651762);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetEntries(8);
   ...
   TPaveText *pt = new TPaveText(9.291519e-316,9.291522e-316,9.531763e-316,9.291519e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
