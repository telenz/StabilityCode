...
//=========  (Thu Aug 21 17:26:40 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,246);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(2,5);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(3,6811);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(4,5975);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,842.785);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(2,16.3538);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(3,23398.75);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(4,20539.93);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,54.1496);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(2,7.340291);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(3,285.6377);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(4,267.8607);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(13037);
   ...
   TPaveText *pt = new TPaveText(9.173663e-316,7.291122e-304,2.335722e-310,8.43799e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
