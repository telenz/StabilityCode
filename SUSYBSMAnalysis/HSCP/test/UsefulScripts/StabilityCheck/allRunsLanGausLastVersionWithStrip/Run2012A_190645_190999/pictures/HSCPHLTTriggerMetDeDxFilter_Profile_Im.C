...
//=========  (Thu Aug 21 17:26:57 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinEntries(3,127);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinEntries(4,86);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(1,7.11016);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(3,428.2807);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(4,290.0524);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(1,5.041211);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(3,38.10589);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(4,31.45361);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetEntries(215);
   ...
   TPaveText *pt = new TPaveText(6.821796e-316,2.335724e-310,9.357865e-316,9.498362e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
