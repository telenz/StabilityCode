...
//=========  (Thu Aug 21 17:33:13 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinContent(1,3.171672);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinContent(4,16.24891);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinError(1,3.171672);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinError(4,7.280996);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetEntries(6);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"193834");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(2,"193835");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(3,"193836");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(4,"193998");
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(5,"193999");
   ...
   TPaveText *pt = new TPaveText(7.890262e-316,7.291122e-304,2.354467e-310,2.521752e+180,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
