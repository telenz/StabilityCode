...
//=========  (Thu Aug 21 17:33:21 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(4,10.68713);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(4,6.246163);
   ...
   TPaveText *pt = new TPaveText(9.340124e-316,9.684146e-316,8.317598e-316,8.089934e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
