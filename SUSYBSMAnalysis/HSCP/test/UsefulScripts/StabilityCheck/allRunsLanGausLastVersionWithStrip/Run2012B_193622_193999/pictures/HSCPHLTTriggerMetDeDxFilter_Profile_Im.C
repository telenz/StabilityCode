...
//=========  (Thu Aug 21 17:31:23 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinEntries(4,170);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinEntries(5,22);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(1,30.71464);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(2,17.32179);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(4,569.3628);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinContent(5,74.92734);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(1,10.25212);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(2,7.750238);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(4,43.80826);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetBinError(5,15.99685);
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->SetEntries(206);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"193834");
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(2,"193835");
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(3,"193836");
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(4,"193998");
   HSCPHLTTriggerMetDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(5,"193999");
   ...
   TPaveText *pt = new TPaveText(9.485241e-316,2.354468e-310,2.354467e-310,8.619313e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
