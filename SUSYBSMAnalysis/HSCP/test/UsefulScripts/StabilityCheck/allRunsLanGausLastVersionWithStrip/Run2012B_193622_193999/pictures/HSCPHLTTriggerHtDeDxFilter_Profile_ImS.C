...
//=========  (Thu Aug 21 17:33:17 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinContent(1,3.254307);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinContent(4,16.5977);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinError(1,3.254307);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetBinError(4,7.439837);
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->SetEntries(6);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"193834");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(2,"193835");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(3,"193836");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(4,"193998");
   HSCPHLTTriggerHtDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(5,"193999");
   ...
   TPaveText *pt = new TPaveText(7.890149e-316,7.291122e-304,2.354467e-310,9.487443e-311,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
