...
//=========  (Thu Aug 21 17:40:32 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(2,330);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,65.60763);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(2,1185.229);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,15.69859);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(2,66.05952);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(348);
   ...
   TPaveText *pt = new TPaveText(4.660283e-316,2.352142e-310,5.99071e-316,7.363469e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
