...
//=========  (Thu Aug 21 17:39:07 2014) by ROOT version5.32/00
   ...
   TProfile *HSCPHLTTriggerMuFilterdEdxMSProf = new TProfile("HSCPHLTTriggerMuFilterdEdxMSProf","",2,0,2,"");
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinEntries(1,3103);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinEntries(2,62708);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinContent(1,10181.57);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinContent(2,206742.6);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinError(1,183.1092);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetBinError(2,827.1136);
   HSCPHLTTriggerMuFilterdEdxMSProf->SetEntries(65811);
   ...
   HSCPHLTTriggerMuFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"204238");
   HSCPHLTTriggerMuFilterdEdxMSProf->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(6.149581e-316,5.990702e-316,7.363355e-316,6.149582e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
