...
//=========  (Thu Aug 21 17:37:44 2014) by ROOT version5.32/00
   ...
   TProfile *AnydEdxMProf = new TProfile("AnydEdxMProf","",2,0,2,"");
   AnydEdxMProf->SetBinEntries(1,3143);
   AnydEdxMProf->SetBinEntries(2,63279);
   AnydEdxMProf->SetBinContent(1,9851.51);
   AnydEdxMProf->SetBinContent(2,199348.4);
   AnydEdxMProf->SetBinError(1,176.1965);
   AnydEdxMProf->SetBinError(2,794.8197);
   AnydEdxMProf->SetEntries(66422);
   ...
   AnydEdxMProf->GetXaxis()->SetBinLabel(1,"204238");
   AnydEdxMProf->GetXaxis()->SetBinLabel(2,"204250");
   ...
   TPaveText *pt = new TPaveText(4.459018e-316,4.459011e-316,4.459018e-316,7.060298e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
