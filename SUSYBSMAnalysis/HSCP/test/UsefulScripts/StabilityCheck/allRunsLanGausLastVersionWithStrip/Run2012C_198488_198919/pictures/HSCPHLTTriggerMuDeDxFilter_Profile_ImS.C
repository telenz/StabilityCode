...
//=========  (Thu Aug 21 17:37:31 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(1,780);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(1,2655.641);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(1,95.29399);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetEntries(780);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(7.655075e-316,7.811938e-316,7.655081e-316,7.655076e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
