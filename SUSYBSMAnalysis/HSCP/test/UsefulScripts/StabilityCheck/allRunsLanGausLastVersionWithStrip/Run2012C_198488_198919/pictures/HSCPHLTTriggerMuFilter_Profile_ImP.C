...
//=========  (Thu Aug 21 17:30:49 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,7984);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,27683.58);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,312.2078);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(7984);
   ...
   TPaveText *pt = new TPaveText(8.935597e-316,7.65131e-316,2.347421e-310,0,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
