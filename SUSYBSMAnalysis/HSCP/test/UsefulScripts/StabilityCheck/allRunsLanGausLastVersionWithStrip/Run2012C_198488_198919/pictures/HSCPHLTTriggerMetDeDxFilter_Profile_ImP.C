...
//=========  (Thu Aug 21 17:32:24 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(1,142);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,520.4661);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,44.09112);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(142);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(5.882876e-316,7.620163e-316,7.966092e-316,5.882877e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
