...
//=========  (Thu Aug 21 17:35:44 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinContent(1,22.76903);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetBinError(1,8.616945);
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->SetEntries(7);
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(4.678526e-316,7.895492e-316,4.678531e-316,4.678527e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
