...
//=========  (Thu Aug 21 17:34:00 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinEntries(1,333);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinContent(1,1097.478);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetBinError(1,60.24827);
   HSCPHLTTriggerL2MuFilterdEdxMSProf->SetEntries(333);
   ...
   HSCPHLTTriggerL2MuFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(7.940897e-316,7.291122e-304,2.347421e-310,7.715936e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
