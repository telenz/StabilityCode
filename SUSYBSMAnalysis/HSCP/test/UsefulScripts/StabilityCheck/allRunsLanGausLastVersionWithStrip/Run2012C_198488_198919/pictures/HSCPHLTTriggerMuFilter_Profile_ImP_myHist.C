...
//=========  (Thu Aug 21 17:30:59 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFiltermyHist->SetBinEntries(1,9135);
   HSCPHLTTriggerMuFiltermyHist->SetBinContent(1,31758.13);
   HSCPHLTTriggerMuFiltermyHist->SetBinError(1,334.855);
   HSCPHLTTriggerMuFiltermyHist->SetEntries(9135);
   ...
   HSCPHLTTriggerMuFiltermyHist->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(7.974542e-316,7.291122e-304,2.347421e-310,8.939866e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
