...
//=========  (Thu Aug 21 17:30:28 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinEntries(1,12571);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinContent(1,40365.29);
   HSCPHLTTriggerMuFilterdEdxMProf->SetBinError(1,361.0309);
   HSCPHLTTriggerMuFilterdEdxMProf->SetEntries(12571);
   ...
   HSCPHLTTriggerMuFilterdEdxMProf->GetXaxis()->SetBinLabel(1,"198522");
   ...
   TPaveText *pt = new TPaveText(7.959854e-316,7.291122e-304,2.347421e-310,0,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
