...
//=========  (Thu Aug 21 17:44:37 2014) by ROOT version5.32/00
   ...
   TProfile *AnymyHist = new TProfile("AnymyHist","",3,0,3,"");
   AnymyHist->SetBinEntries(1,74162);
   AnymyHist->SetBinEntries(2,2867);
   AnymyHist->SetBinEntries(3,4183);
   AnymyHist->SetBinContent(1,259785.4);
   AnymyHist->SetBinContent(2,10142.14);
   AnymyHist->SetBinContent(3,14734.78);
   AnymyHist->SetBinError(1,962.3114);
   AnymyHist->SetBinError(2,191.2216);
   AnymyHist->SetBinError(3,229.9286);
   AnymyHist->SetEntries(81212);
   ...
   AnymyHist->GetXaxis()->SetBinLabel(1,"207515");
   AnymyHist->GetXaxis()->SetBinLabel(2,"207517");
   AnymyHist->GetXaxis()->SetBinLabel(3,"207518");
   ...
   TPaveText *pt = new TPaveText(6.678681e-316,2.340405e-310,2.340403e-310,6.676568e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
   TText *text = pt->AddText("p‰ª");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
