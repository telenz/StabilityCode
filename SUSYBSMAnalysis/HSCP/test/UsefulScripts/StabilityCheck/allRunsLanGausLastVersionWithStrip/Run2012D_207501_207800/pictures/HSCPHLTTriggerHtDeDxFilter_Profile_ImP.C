...
//=========  (Thu Aug 21 17:48:51 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinContent(1,27.83482);
   HSCPHLTTriggerHtDeDxFilterdEdxMPProf->SetBinError(1,9.916015);
   ...
   TPaveText *pt = new TPaveText(8.263109e-316,7.291122e-304,2.340403e-310,8.072106e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
