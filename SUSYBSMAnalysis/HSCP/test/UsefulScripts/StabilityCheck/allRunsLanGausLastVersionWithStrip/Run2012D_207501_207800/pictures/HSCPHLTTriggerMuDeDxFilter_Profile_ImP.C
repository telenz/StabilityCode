...
//=========  (Thu Aug 21 17:49:53 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,1856);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(2,82);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(3,135);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,6692.076);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(2,298.2807);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(3,497.4205);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,157.3814);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(2,33.46296);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(3,43.35979);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(2073);
   ...
   TPaveText *pt = new TPaveText(6.072305e-316,0,6.072306e-316,6.312618e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
