...
//=========  (Thu Aug 21 17:46:48 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(1,261);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(2,12);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinEntries(3,12);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,939.5776);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(2,43.43496);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(3,44.93189);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,59.01667);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(2,12.56798);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(3,13.16684);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(285);
   ...
   TPaveText *pt = new TPaveText(7.623668e-316,7.291122e-304,2.340403e-310,6.479055e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
