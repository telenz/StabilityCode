...
//=========  (Thu Aug 21 17:30:52 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinContent(1,3.15569);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetBinError(1,3.15569);
   HSCPHLTTriggerMetDeDxFilterdEdxMPProf->SetEntries(1);
   ...
   TPaveText *pt = new TPaveText(7.443884e-316,2.353032e-310,7.515443e-316,5.762066e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
