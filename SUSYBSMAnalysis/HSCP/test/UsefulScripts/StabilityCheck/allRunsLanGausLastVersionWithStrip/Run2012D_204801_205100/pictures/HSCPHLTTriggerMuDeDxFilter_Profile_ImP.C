...
//=========  (Thu Aug 21 17:34:54 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinEntries(1,11);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinContent(1,41.53018);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetBinError(1,12.61307);
   HSCPHLTTriggerMuDeDxFilterdEdxMPProf->SetEntries(11);
   ...
   TPaveText *pt = new TPaveText(7.514533e-316,7.187228e-316,0,7.163952e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
