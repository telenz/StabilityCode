...
//=========  (Thu Aug 21 17:34:44 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinEntries(1,13);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinContent(1,44.86059);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetBinError(1,12.46241);
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->SetEntries(13);
   ...
   HSCPHLTTriggerMuDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.578021e-316,2.353032e-310,7.290246e-316,7.510091e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
