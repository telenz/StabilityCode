...
//=========  (Thu Aug 21 17:28:03 2014) by ROOT version5.32/00
   ...
   AnymyHist->SetBinEntries(1,286);
   AnymyHist->SetBinContent(1,1012.656);
   AnymyHist->SetBinError(1,60.47775);
   AnymyHist->SetEntries(286);
   ...
   AnymyHist->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.47457e-316,2.353032e-310,7.194127e-316,7.242769e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
   TText *text = pt->AddText("po");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
