...
//=========  (Thu Aug 21 17:30:41 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetBinContent(1,7.096824);
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetBinError(1,5.038494);
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->SetEntries(2);
   ...
   HSCPHLTTriggerMetDeDxFilterdEdxMSProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.383373e-316,2.353032e-310,7.476602e-316,7.523567e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
