...
//=========  (Thu Aug 21 17:31:04 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMetDeDxFiltermyHist->SetBinContent(1,6.649377);
   HSCPHLTTriggerMetDeDxFiltermyHist->SetBinError(1,4.706328);
   HSCPHLTTriggerMetDeDxFiltermyHist->SetEntries(2);
   ...
   HSCPHLTTriggerMetDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.40997e-316,7.316012e-316,2.371515e-322,4.792437e-322,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
