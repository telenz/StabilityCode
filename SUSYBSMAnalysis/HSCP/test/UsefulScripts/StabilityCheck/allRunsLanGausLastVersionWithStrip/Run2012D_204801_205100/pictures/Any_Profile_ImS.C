...
//=========  (Thu Aug 21 17:27:38 2014) by ROOT version5.32/00
   ...
   AnydEdxMSProf->SetBinEntries(1,360);
   AnydEdxMSProf->SetBinContent(1,1191.273);
   AnydEdxMSProf->SetBinError(1,62.898);
   AnydEdxMSProf->SetEntries(360);
   ...
   AnydEdxMSProf->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(6.629995e-316,2.353032e-310,7.382922e-316,7.419985e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
