...
//=========  (Thu Aug 21 17:33:47 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerHtDeDxFiltermyHist->GetXaxis()->SetBinLabel(1,"205086");
   ...
   TPaveText *pt = new TPaveText(7.511292e-316,2.353032e-310,7.589965e-316,7.354225e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
