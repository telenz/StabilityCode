...
//=========  (Thu Aug 21 17:29:27 2014) by ROOT version5.32/00
   ...
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinEntries(1,148);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinContent(1,511.4369);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetBinError(1,42.4288);
   HSCPHLTTriggerMuFilterdEdxMPProf->SetEntries(148);
   ...
   TPaveText *pt = new TPaveText(7.220682e-316,7.583857e-316,7.220687e-316,7.220682e-316,"brNDC");
   pt->SetFillColor(0);
   pt->SetTextAlign(12);
   pt->SetTextFont(43);
   pt->SetTextSize(21);
