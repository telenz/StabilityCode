#!/bin/bash/
ppp=/afs/cern.ch/user/t/telenz/work/CMSSW_5_3_14_patch2/src/SUSYBSMAnalysis/HSCP/test/UsefulScripts/StabilityCheck/allRunsLanGausLastVersionWithStrip/Run2012D_204801_205100
cd $ppp
echo $ppp  
