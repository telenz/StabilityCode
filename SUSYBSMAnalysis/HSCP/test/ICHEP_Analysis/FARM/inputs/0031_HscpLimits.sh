...
root -l -b << EOF
   ...
   .x /afs/cern.ch/work/t/telenz/CMSSW_5_3_7_patch4/src/SUSYBSMAnalysis/HSCP/test/ICHEP_Analysis/Analysis_Step6.C+("COMBINE", "Results/Type2/",  "pMSSM12_MCMC1_30_549144_m200_width0" )
   .q
EOF
