...
root -l -b << EOF
   ...
   .x /afs/cern.ch/work/t/telenz/CMSSW_5_3_7_patch4/src/SUSYBSMAnalysis/HSCP/test/ICHEP_Analysis/Analysis_Step3.C+("ANALYSE_532_to_532", 2, "dedxASmi", "dedxHarm2", "combined", 0.0, 0.0, 0.0, 45, 2.1)
   .q
EOF
